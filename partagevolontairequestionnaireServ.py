...
from partagevolontairequestionnaireGui import DConfigure
...
class Serveur(object):
    def __init__(self, le2mserv):
        ...
        actions[le2mtrans(u"Display payoffs")] = \
            ...
            display_payoffs_onserver("partagevolontairequestionnaire")
        self._le2mserv.gestionnaire_graphique.add_topartmenu(
            u"Partage volontaire - Questionnaire", actions)
